(function() {
  ...
  var list = [
    ...
    { type: 'naive', id: 'angular2', url: './angular2', label: 'DBMON Angular 2.0 Beta' },
	...
	{ type: 'optimized', id: 'angular2-dart', url: './angular2-dart/build-opt/web/index.html', label: 'DBMON Angular 2.0 Dart Beta' },
